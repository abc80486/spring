...
public class GetKlineData {
    ...
    public static List<MinuteData> get_binance_kline(String symbol, String interval, int limit, long start) {
        ...
        url += "&limit=" + limit;
        if(start!=-1l) url += "&startTime=" + start;
...
//System.out.print(url);
    ...
    public static List<MinuteData> getLately(String symbol,String interval,int limit){
        return get_binance_kline(symbol, interval, limit, -1l);
    }
}