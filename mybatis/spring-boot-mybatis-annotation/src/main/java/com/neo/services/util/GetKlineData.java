...
public class GetKlineData {
    ...
    public static List<MinuteData> get_binance_kline(String symbol, String interval, int limit, long start) {
        ...
        JSONArray sd = (JSONArray) JSON.parse(url);
        for(int i=0;i<sd.size();i++){

            JSONArray tm = (JSONArray) sd.get(i);
            re.get(i).setStart_time(tm.getLongValue(0));
            re.get(i).setOpen_price(tm.getDoubleValue(1));
            re.get(i).setTop_price(tm.getDoubleValue(2));
            re.get(i).setLow_price(tm.getDoubleValue(3));
            re.get(i).setClose_price(tm.getDoubleValue(4));
            re.get(i).setAmount(tm.getDoubleValue(5));
            re.get(i).setEnd_time(tm.getLongValue(6));
            re.get(i).setQuantity(tm.getDoubleValue(7));
            re.get(i).setExchange_lots(tm.getDoubleValue(8));
            re.get(i).setVol_amount(tm.getDoubleValue(9));
            re.get(i).setVol_quantity(tm.getDoubleValue(10));
        }
        return re;
    }
